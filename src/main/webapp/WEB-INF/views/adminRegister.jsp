                ...
                <form action="${pageContext.request.contextPath}/admin/registerAdmin" method="post">
                    ...
                    <div class="fdf-form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="name" class="fdf-input" placeholder="e.g. Jane Doe" required>
                        </div>
                    </div>
                    ...
                    <div class="fdf-form-group">
                        ...
                        <div class="input-wrapper password-field">
                            ...
                            <input type="password" id="password" name="password" class="fdf-input" placeholder="••••••••" required autocomplete="new-password">
                    ...
                    <button type="submit" class="btn-fdf-login">
                        Register Admin <i class="bi bi-person-plus-fill"></i>
                    </button>
                </form>
                
                <div class="register-link">
                    Already an Administrator? <a href="${pageContext.request.contextPath}/admin/loginAdmin">Sign In</a>
                </div>
            </div>
        </div>
    </div>
