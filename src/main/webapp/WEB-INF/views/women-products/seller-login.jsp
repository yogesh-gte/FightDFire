...
<head>
    ...
    <title>Seller Login — Fight D Fear</title>
            ...
            <div class="login-card">
                ...
                <c:if test="${param.registered == 'true'}">
                    <div class="alert" style="background:#f0fdf4; color:#15803d; border-color:#bbf7d0;">
                        <i class="bi bi-shield-check-fill"></i> Account registered! Verification pending.
                    </div>
                </c:if>
                ...
                <p class="register-link">
                    Don't have an account? <a href="${pageContext.request.contextPath}/women-products/seller/register">Create one here</a>
                </p>
            </div>
        </div>
    </div>
